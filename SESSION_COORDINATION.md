...
| **C** (Monitoring/Drift) | `feature/monitoring` | `worktrees/session-c` | In progress | C.2 Streamlit dashboard | C.1 done |
...
| `streamlit` | C | `>=1.30.0` | Installed in oc6 env (1.54.0) — add to requirements-streamlit.txt |
| `joblib` | A, B | `>=1.3.0` | No |
